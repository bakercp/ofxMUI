...
//  BasicExample
//
//  Created by Christopher Baker on 2/6/12.
...
//--------------------------------------------------------------
static void applyTruncation(ofxGuiTrueTypeFont* ttf,
                         string& stringToTruncate,
                         float& stringToTruncateWidth,
                         float maximumWidth,
                         ofxGuiLineTruncationMode lineTruncationMode,
...
static void applyCaps(string& displayText, ofxGuiCapsMode capsStyle) {
...
//--------------------------------------------------------------
static void breakLines(ofxGuiTrueTypeFont* ttf,
                       string& stringToWrap,
                       vector<int>& breakPos,
                       ...
                       const ofxGuiLineBreakMode lineBreakMode = LINE_BREAK_MODE_NONE, 
                       const string delimiters = " ",
                       const ofxGuiLineTruncationMode lineTruncationMode = LINE_TRUNCATION_MODE_CLIP, 
