...
class ofxGuiColorPicker : public ofxGuiLabelledObject, public ofxGuiNumberData {
public:
    
    ofxGuiColorPicker(string _name, int _x, int _y, int _width, int _height, bool _enabled = true);
    ofxGuiColorPicker(string _name, int _x, int _y,bool _enabled = true);
    ofxGuiColorPicker(string _name, bool _enabled = true);
    ofxGuiColorPicker(bool _enabled = true);
    virtual ~ofxGuiColorPicker();
...
protected:
    ...
    ofEvent<ofColor> ofxGuiColorPickerEvent;
