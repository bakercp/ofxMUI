...
public:
    ...
    void setCapsStyle(ofxGuiLabelCaps _capsStyle);
    ofxGuiLabelCaps getCapsStyle();

    void setLineBreakMode(ofxGuiLabelLineBreakMode _lineBreakMode);
    ofxGuiLabelLineBreakMode getLineBreakMode();
