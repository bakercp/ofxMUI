...
ofxGuiColorPicker::ofxGuiColorPicker(string _name, int _x, int _y, int _width, int _height, bool _enabled) : 
ofxGuiLabelledObject(_name, _x, _y, _width, _height, _enabled),
ofxGuiNumberData(OFXGUI_FLOAT_ARRAY, 4) {
    init();
}

//--------------------------------------------------------------
ofxGuiColorPicker::ofxGuiColorPicker(string _name, int _x, int _y,bool _enabled) : 
...
//--------------------------------------------------------------
ofxGuiColorPicker::ofxGuiColorPicker(string _name,bool _enabled) :
...
//--------------------------------------------------------------
ofxGuiColorPicker::ofxGuiColorPicker(bool _enabled) : 
...
//--------------------------------------------------------------
ofxGuiColorPicker::~ofxGuiColorPicker() {
}

//--------------------------------------------------------------
void ofxGuiColorPicker::update() {
    ofColor c = getValue();
...
//--------------------------------------------------------------
void ofxGuiColorPicker::dataChanged() {
    //ofNotifyEvent(ofxGuiColorPickerEvent, value, this);
}


//--------------------------------------------------------------
//void ofxGuiColorPicker::keyBind_toggleValue(int key) {
//    setKeyMap(key,bind(&ofxGuiButton::toggleValue, ref(*this))); 
//}

//--------------------------------------------------------------
void ofxGuiColorPicker::draw() {
...
//--------------------------------------------------------------
void ofxGuiColorPicker::onDragOutside() {
    showEyeDroperPreview = true;
    
}

//--------------------------------------------------------------
void ofxGuiColorPicker::onReleaseOutside() {
...
void ofxGuiColorPicker::generatePicker (int w, int h)
{
    // draw color.
...
void ofxGuiColorPicker::setGradient(int x, int y, float w, float h, ofColor c1, ofColor c2 )
{
...
void ofxGuiColorPicker::drawRect( int rx, int ry, int rw, int rh, ofColor rc ) {
