...
//--------------------------------------------------------------
void ofxGuiLabel::setCapsStyle(ofxGuiLabelCaps _capsStyle) {
    capsStyle = _capsStyle;
    requestBoxLayout();
}

//--------------------------------------------------------------
ofxGuiLabelCaps ofxGuiLabel::getCapsStyle() { 
    return capsStyle;
}

//--------------------------------------------------------------
void ofxGuiLabel::setLineBreakMode(ofxGuiLabelLineBreakMode _lineBreakMode) {
