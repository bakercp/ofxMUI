...
public:
    ...
    ofxGuiColor();    
    ofxGuiColor(ofColor _all);    
    ofxGuiColor(ofColor _normal, ofColor _hover, ofColor _active);
    ofxGuiColor(ofColor _normal, ofColor _hover, ofColor _active, ofColor _disabled);
