...
//--------------------------------------------------------------
ofxGuiColor::ofxGuiColor(ofColor _normal) :
    normal(_normal),
    hover(_normal),
    active(_normal),
    disabled(_normal)
...
//--------------------------------------------------------------
ofxGuiColor::ofxGuiColor(ofColor _normal, ofColor _hover, ofColor _active) :
    normal(_normal),
    hover(_hover),
    active(_active),
    disabled(COLOR_DISABLED_DEFAULT)
...
//--------------------------------------------------------------
ofxGuiColor::ofxGuiColor(ofColor _normal, ofColor _hover, ofColor _active, ofColor _disabled) :
    normal(_normal),
    hover(_hover),
    active(_active),
    disabled(_disabled)
...
//--------------------------------------------------------------
ofColor ofxGuiColor::get(bool isOver, bool isActive, bool isEnabled, float alphaScale) {
    ofColor cOut = normal;
