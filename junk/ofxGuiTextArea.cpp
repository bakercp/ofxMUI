...
//--------------------------------------------------------------
void ofxGuiLabel::setCapsStyle(int _capsStyle) {
    capsStyle = _capsStyle;
    requestBoxLayout();
}

//--------------------------------------------------------------
int ofxGuiLabel::getCapsStyle() const {
    return capsStyle;
}

//--------------------------------------------------------------
void ofxGuiLabel::setLineBreakMode(int _lineBreakMode) {
    lineBreakMode = _lineBreakMode;
    requestBoxLayout();
}

//--------------------------------------------------------------
int ofxGuiLabel::getLineBreakMode() const {
